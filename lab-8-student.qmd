...
ChatGBT Link: https://chatgpt.com/share/6747c4cd-8560-8011-a128-d02b21f0a54d
...
```{r}
#| label: map-missing-values-fish

height <- function(obs = 200, mean, sd) {
  
  tibble(person = 1:obs, 
         ht = rnorm(n = obs, mean = mean, sd = sd)
  )
